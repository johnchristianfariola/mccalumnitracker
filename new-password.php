...
// Find the alumni with the matching reset token
$matching_alumni = null;
$alumni_key = null;
foreach ($alumni as $key => $alum) {
    if (isset($alum['reset_token_hash']) && $alum['reset_token_hash'] === $token_hash) {
        $matching_alumni = $alum;
        $alumni_key = $key;
        break;
    }
}
...
if (isset($matching_alumni["reset_token_expires_at"]) && strtotime($matching_alumni["reset_token_expires_at"]) <= time()) {
...
// Make sure to pass $alumni_key to the change-password handler in controllerUserData.php
?>
            ...
            <div class="wrap-login100">
                ...
                <div id="form-container" class="form-container">
                    <form class="login100-form validate-form" action="" method="POST">
                        ...
                        <input type="hidden" name="alumni_key" value="<?php echo htmlspecialchars($alumni_key); ?>">
